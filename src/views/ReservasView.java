...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		JLabel lblSiguiente = new JLabel("SIGUI");
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if(ReservasView.txtFechaEntrada.getCalendar()!=null && ReservasView.txtFechaSalida.getCalendar()!=null) {
				String dateFechaE = ((JTextField) txtFechaEntrada.getDateEditor().getUiComponent()).getText();
				String dateFechaS = ((JTextField) txtFechaSalida.getDateEditor().getUiComponent()).getText();
				
				long valor = calculoValor(dateFechaE, dateFechaS);
				if (valor>0) {
					System.out.println(valor);
					valor*=1200;
					ReservasView.txtValor.setText(String.valueOf(valor));
				}else {
					ReservasView.txtValor.setText("0");
					JOptionPane.showMessageDialog(contentPane, "La fecha de Salida no puede ser la misma o anterior que la de entrada");
				}
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null &&  Integer.valueOf(ReservasView.txtValor.getText())>0) {
					Integer idDevuelto = guardarReserva();
					RegistroHuesped registro = new RegistroHuesped(idDevuelto);
	...
	private Integer guardarReserva() {
		...
		String dateEntrada = ((JTextField) txtFechaEntrada.getDateEditor().getUiComponent()).getText();
		String dateSalida = ((JTextField) txtFechaSalida.getDateEditor().getUiComponent()).getText();
...
return idDevuelto;
	...
	public long calculoValor(String dateE, String dateS) {
//		long fechaInicialMs = txtFechaSalida2.getTime();
//		long fechaFinalMs = txtFechaEntrada2.getTime();
...
//		return dias;
		        ...
		        try {
		            ...
		            java.util.Date date2 = sdf.parse(dateE);
