...
public class RegistroHuesped extends JFrame {
	...
	private static Integer idDevuelto;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegistroHuesped frame = new RegistroHuesped(idDevuelto);
	 ...
	 * Create the frame.
	 */
	public RegistroHuesped(Integer idDevuelto) {
		...
		txtNreserva.setText(String.valueOf(idDevuelto));
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (RegistroHuesped.txtNombre.getText() != null) {
					Integer idDevuelto=guardarHuesped();
					JOptionPane.showMessageDialog(null, "Huesped Guardado con Exito bajo el id: "+idDevuelto);
				} else {
	...
	private Integer guardarHuesped() {
		...
		String dateNacimiento = ((JTextField) txtFechaN.getDateEditor().getUiComponent()).getText();
		...
		Huesped nuevoHuesped = new Huesped(nombre, apellido, fechaNacimiento, nacionalidad, telefono, idreserva);
		
		Integer idDevuelto=0;
		try {
			idDevuelto=huespedController.guardarHuesped(nuevoHuesped);
		} catch (SQLException e) {
			throw new RuntimeException(e);
		}
		JOptionPane.showMessageDialog(contentPane, "Huesped Guardado con Exito ");
		return idDevuelto;
	}
